...
import com.iabtcf.model.ConsentLanguages;
import com.iabtcf.model.gvl.*;
...
public class GVL extends VendorList {
    ...
    public static void setBaseUrl(String baseUrl) {
        Pattern p = Pattern.compile("^(https?:\\/\\/vendorlist\\.consensu\\.org\\/?.*)");
        if(p.matcher(baseUrl).matches()) {
            // throw error
        }
